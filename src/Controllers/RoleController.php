...
class RoleController extends Controller
{
    ...
    {
        return view(cwView('roles.index', true));
    }
    ...
    public function create()
    {
        ...
        return view(cwView('roles.create', true), $this->data);
    }
    ...
    public function show($id)
    {
        ...
        return view(cwView('roles.show', true), $this->data);
    }
    ...
    public function edit($id)
    {
        $this->data['permissions'] = resolve('PermissionService')->pluck();
        $this->data['role'] = resolve('RoleService')->find($id);
        return view(cwView('roles.edit', true), $this->data);
    }
