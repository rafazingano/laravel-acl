...
class PermissionController extends Controller
{
    ...
    {
        return view(cwView('permissions.index', true));
    }
    ...
    {
        return view(cwView('permissions.create', true), $this->data);
    }
    ...
    public function show($id)
    {
        ...
        return view(cwView('permissions.show', true), $this->data);
    }
    ...
    {
        $this->data['permission'] = resolve('PermissionService')->find($id);
        return view(cwView('permissions.edit', true), $this->data);
    }
